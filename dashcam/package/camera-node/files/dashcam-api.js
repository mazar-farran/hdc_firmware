/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 1546: /***/ (
      ...
      exports.configureOnBoot =
        exports.LED_CONFIG_PATH =
        exports.BUILD_INFO_PATH =
        exports.LORA_ROOT_FOLDER =
        exports.IMU_ROOT_FOLDER =
        exports.GPS_ROOT_FOLDER =
        exports.FRAMES_ROOT_FOLDER =
        exports.PORT =
          void 0;
    ...
    /***/ 647: /***/ function (
      ...
      async function initAppServer() {
        ...
        console.log(
          `Dashcam API (process ${process.pid}) started and listening on ${config_1.PORT}`
        );
      ...
      initAppServer();
      //# sourceMappingURL=data:application/json;base64,
        ...
        try {
          ...
          const jpgFiles = files
            ...
            .map((filename) => {
              return {
                path: filename,
                date: (0, util_1.getDateFromUnicodeTimastamp)(
                  filename
                ).getTime(),
              };
            });
    ...
    /***/ 4016: /***/ (
      ...
      router.get("/", async (req, res) => {
        try {
          const files = (0, fs_1.readdirSync)(config_1.GPS_ROOT_FOLDER);
          if (files.length) {
          ...
          const gpsFiles = files
            ...
            .map((filename) => {
              return {
                path: filename,
                date: (0, util_1.getDateFromFilename)(filename).getTime(),
              };
            });
    ...
    /***/ 608: /***/ (
      ...
      router.get("/", async (req, res) => {
        try {
          const files = (0, fs_1.readdirSync)(config_1.IMU_ROOT_FOLDER);
          if (files.length) {
          ...
          res.json((0, util_1.filterBySinceUntil)(imuFiles, req));
        } catch (error) {
          res.json({ error });
        }
      });
      ...
      exports["default"] = router;
      //# sourceMappingURL=data:application/json;base64,
    ...
    /***/ 4154: /***/ function (
      ...
      router.get("/info", async (req, res) => {
        let versionInfo = {};
        try {
          const versionInfoPayload = (0, fs_1.readFileSync)(
            config_1.BUILD_INFO_PATH,
            {
              encoding: "utf-8",
            }
          );
    ...
    /***/ 8956: /***/ (
      ...
      router.get("/", async (req, res) => {
        try {
          const files = (0, fs_1.readdirSync)(config_1.LORA_ROOT_FOLDER);
          if (files.length) {
            // Last IMU file is not finished yet
            files.pop();
          }
          ...
          res.json((0, util_1.filterBySinceUntil)(loraFiles, req));
        } catch (error) {
          res.json({ error });
        }
      });
    ...
    /***/ 5960: /***/ (__unused_webpack_module, exports) => {
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.filterBySinceUntil =
        exports.getDateFromUnicodeTimastamp =
        exports.getDateFromFilename =
          void 0;
      ...
      exports.getDateFromUnicodeTimastamp = getDateFromUnicodeTimastamp;
      const filterBySinceUntil = (files, req) => {
        if (req.query.since || req.query.until) {
          const since = Number(req.query.since);
          const until = Number(req.query.until);
          return files.filter((file) => {
            return !(
              (since && file.date < since) ||
              (until && file.date > until)
            );
          });
        } else {
          return files;
      ...
      //# sourceMappingURL=data:application/json;base64,
    ...
    /***/ 1519: /***/ (module, exports, __nccwpck_require__) => {
      /**
    ...
    /***/ 9963: /***/ (module, exports, __nccwpck_require__) => {
      /**
    ...
    /***/ 6894: /***/ (module, exports, __nccwpck_require__) => {
      /**
       * Module dependencies.
       */
    ...
    /***/ 5675: /***/ (module, exports, __nccwpck_require__) => {
    ...
    /***/ 8220: /***/ (__unused_webpack_module, exports) => {
      "use strict";
      /*!
       * content-type
       * Copyright(c) 2015 Douglas Christopher Wilson
    ...
    /***/ 12: /***/ (module, exports, __nccwpck_require__) => {
      "use strict";
      /*!
       * express
       * Copyright(c) 2009-2013 TJ Holowaychuk
    ...
    /***/ 2099: /***/ (module, exports, __nccwpck_require__) => {
      "use strict";
      /*!
       * express
       * Copyright(c) 2009-2013 TJ Holowaychuk
    ...
    /***/ 6002: /***/ (module, exports, __nccwpck_require__) => {
      /**
       * This is the web browser implementation of `debug()`.
       *
       * Expose `debug()` as the module.
    ...
    /***/ 7118: /***/ (module, exports, __nccwpck_require__) => {
      /**
       * This is the common logic for both the Node.js and web browser
       * implementations of `debug()`.
       *
    ...
    /***/ 4890: /***/ (module, exports, __nccwpck_require__) => {
      /**
       * Module dependencies.
       */
    ...
    /***/ 4168: /***/ (module, exports, __nccwpck_require__) => {
      /*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */
      /* eslint-disable node/no-deprecated-api */
      var buffer = __nccwpck_require__(4300);
      var Buffer = buffer.Buffer;
    ...
    /***/ 6431: /***/ (module, exports, __nccwpck_require__) => {
      /**
       * This is the web browser implementation of `debug()`.
       *
       * Expose `debug()` as the module.
    ...
    /***/ 5101: /***/ (module, exports, __nccwpck_require__) => {
      /**
       * Module dependencies.
       */
    ...
    /***/ 4801: /***/ (__unused_webpack_module, exports) => {
      "use strict";
    ...
    /***/ 6411: /***/ (
      ...
      iconv.getCodec = function getCodec(encoding) {
        if (!iconv.encodings) iconv.encodings = __nccwpck_require__(7694); // Lazy load all encoding definitions.
    ...
    /***/ 3519: /***/ (__unused_webpack_module, exports) => {
      /*!
       * media-typer
    ...
    /***/ 6763: /***/ (module, exports, __nccwpck_require__) => {
      /**
       * This is the common logic for both the Node.js and web browser
       * implementations of `debug()`.
       *
    ...
    /***/ 6207: /***/ (
      ...
      exports.configureOnBoot = configureOnBoot;
      //# sourceMappingURL=data:application/json;base64,
    ...
    /***/ 669: /***/ (__unused_webpack_module, exports) => {
      "use strict";
      ...
      //# sourceMappingURL=data:application/json;base64,
    ...
    /***/ 118: /***/ (
      ...
      exports.LedService = {
        execute: async () => {
          try {
            const ubxtoolOutput = (0, child_process_1.execSync)(
              "ubxtool -p NAV-PVT | grep fix",
              {
                encoding: "utf-8",
              }
            );
            const imgOutput = (0, child_process_1.execSync)(
              "ls " + config_1.FRAMES_ROOT_FOLDER + " | tail -2",
              {
                encoding: "utf-8",
              }
            );
      ...
      //# sourceMappingURL=data:application/json;base64,
    ...
    /***/ 4011: /***/ (
      ...
      const updateLED = async (framesLED, gpsLED, appLED) => {
        try {
          ...
          try {
            const ledPayload = (0, fs_1.readFileSync)(
              config_1.LED_CONFIG_PATH,
              {
                encoding: "utf-8",
              }
            );
      ...
      //# sourceMappingURL=data:application/json;base64,
