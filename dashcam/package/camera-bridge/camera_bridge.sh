...
cpulimit -l 150 ./libcamera-bridge --config camera_bridge_config.json --config-override /mnt/data/camera_bridge_config.json --segment 0  --timeout 0 --tuning-file imx477.json
